        ...
        if scheduler_outputs is not None:
            ...
            for seq_group in scheduler_outputs.scheduled_seq_groups:
                ...
                if seq_group.is_finished():
                    ...
                    seq_group.metrics.e2e_latency = now - seq_group.metrics.arrival_time

                    print("TTFT and decode latency with request ID:", seq_group.metrics.last_token_time-seq_group.metrics.arrival_time-seq_group.metrics.finished_time+seq_group.metrics.first_token_time, seq_group.metrics.finished_time-seq_group.metrics.first_token_time, seq_group.request_id)

            time_to_first_tokens = time_last_iters if prompt_run else []
            
            time_per_output_tokens = [] if prompt_run else time_last_iters
            if prompt_run:
                print("TTFT:",time_to_first_tokens)
